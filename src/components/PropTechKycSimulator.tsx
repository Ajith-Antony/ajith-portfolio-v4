...
export default function PropTechKycSimulator() {
  ...
  return (
    <section id="proptech-demo" className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative z-10 font-sans">
      ...
      <div className="text-center max-w-3xl mx-auto mb-12">
        ...
        <h2 className="text-3xl sm:text-5xl font-extrabold text-[var(--semantic-fg)] tracking-tight">
          Shufti KYC Verification & <span className="ds-gradient-text">POA Valuation Gateway</span>
        </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7">
          <div className="editorial-panel-bold p-6 sm:p-8 relative overflow-hidden bg-[var(--semantic-surface-card)] h-full flex flex-col justify-between">
            ...
            <div>
              ...
              {/* Step Content Card (Always Dark Workbench Box with Bright White/Emerald Text) */}
            ...
            <div className="flex items-center justify-between pt-4 border-t-2 border-[var(--semantic-border-bold)]">
              ...
              {kycStep < 3 && (
                <button
                  ...
                  className="ds-btn-primary text-xs flex items-center gap-2 border-2 border-black shadow-[3px_3px_0px_#000]"
                >
        ...
        <div className="lg:col-span-5 flex flex-col space-y-6">
          ...
          <div className="editorial-panel-bold p-6 bg-[var(--semantic-surface-card)]">

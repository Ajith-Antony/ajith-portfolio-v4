...
export default function CommandHeader({ onOpenCommandPalette, onOpenResume }: HeaderProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 apple-glass transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6 font-mono text-xs font-bold text-[var(--semantic-fg-muted)]">
          ...
          <a href="#cases" className="hover:text-[var(--semantic-primary)] transition-colors">02. Case Dossiers</a>
          <a href="#terminal" className="hover:text-[var(--semantic-primary)] transition-colors">03. Terminal</a>
          <a href="#skills" className="hover:text-[var(--semantic-primary)] transition-colors">04. Skill Radar</a>
        </nav>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={toggleTheme}
            className="p-2.5 rounded-md bg-[var(--semantic-surface)] border-2 border-[var(--semantic-border-bold)] text-[var(--semantic-fg)] hover:border-[var(--semantic-primary)] active:scale-[0.97] transition-all"
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-2 px-3.5 py-2 rounded-md bg-[var(--semantic-surface)] border-2 border-[var(--semantic-border-bold)] text-[var(--semantic-fg)] hover:border-[var(--semantic-primary)] active:scale-[0.97] text-xs font-mono font-bold transition-all"
          >
